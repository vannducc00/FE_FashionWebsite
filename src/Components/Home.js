        ...
        return (
            <div style={{ paddingTop: "130px" }}>
                ...
                <div style={{ textAlign: "center", padding: "35px 80px 58px 80px" }}>
                    ...
                    <button className="button-gender" style={{ borderRight: "0.5px solid black" }}>WOMEN</button>
                    <button className="button-gender" style={{ borderLeft: "0.5px solid black" }}>MEN</button>
                </div>
